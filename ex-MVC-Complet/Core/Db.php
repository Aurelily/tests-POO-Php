...
class Db extends PDO
{
    ...
    private function __construct()
    {
        ...
        try {
            ...
            // Le mode FETCH_ASSOC ci dessous rendra tous les résultats du Fetch sous forme de tableau associatifs (ex. : $annonce['titre])
            // Pour de la POO il est plus adapté de faire du FETCH_OBJ et de recup les éléments avec des fleches plutôt que des crochets de tableau (ex. : $annonce->titre)
