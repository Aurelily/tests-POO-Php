...
class ConcreteProduct
{
    ...
    public function setId(?int $id): ConcreteProduct
    {
        $this->id = $id;
        return $this;
    }
    ...
    public function setName(?string $name): ConcreteProduct
    {
        $this->name = $name;
        return $this;
    }
    ...
    public function setPhotos(?array $photos): ConcreteProduct
    {
        $this->photos = $photos;
        return $this;
    }
    ...
    public function setPrice(?int $price): ConcreteProduct
    {
        $this->price = $price;
        return $this;
    }
    ...
    public function setDescription(?string $description): ConcreteProduct
    {
        $this->description = $description;
        return $this;
    }
    ...
    public function setQuantity(?int $quantity): ConcreteProduct
    {
        $this->quantity = $quantity;
        return $this;
    }
    ...
    public function setCategoryId(?int $category_id): ConcreteProduct
    {
        $this->category_id = $category_id;
        return $this;
    }
    ...
    public function setCreatedAt(?\DateTime $createdAt): ConcreteProduct
    {
        $this->createdAt = $createdAt;
        return $this;
    }
    ...
    public function setUpdatedAt(?\DateTime $updatedAt): ConcreteProduct
    {
        $this->updatedAt = $updatedAt;
        return $this;
    }
